...
class FormNCD400ConsumerUseTaxWkst(Form):
    ...
    def __init__(self, **kwargs):
        ...
        optional_fields = [
            ...
            FloatField(
                "3", lambda s, i, v: min(i["other_state_sales_tax"], v["2"]), places=0
            ),
            FloatField("4", lambda s, i, v: round(v["2"] - v["3"], 0), places=0),
            FloatField(
                "consumer_use_tax",
                lambda s, i, v: v["4"] if i["full_records"] else v["estimate"],
                places=0,
            ),
        ]
