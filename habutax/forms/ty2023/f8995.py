...
class Form8995(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            BooleanInput(
                "schedule_d", description="Are you required to file schedule D?"
            ),
        ]
        ...
        optional_fields = [
            FloatField(
                "2",
                lambda s, i, v: s.not_implemented() if i["other_than_199a"] else None,
            ),
            FloatField(
                "3",
                lambda s, i, v: s.not_implemented() if i["other_than_199a"] else None,
            ...
            FloatField(
                "6",
                lambda s, i, v: sum(
                    [v[f"1099-div:{n}.box_5"] for n in range(i["1040.number_1099-div"])]
                ),
            ),
            FloatField(
                "7",
        ...
        pdf_fields = [
            ...
            TextPDFField(
                "topmostSubform[0].Page1[0].ReadOrderSubForm[0].f1_18[0]", "2"
            ),
