...
class Form8959(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            BooleanInput(
                "other_medicare_income",
                description="Do you have any unreported tip income (Form 4137, line 6) or wages on which medicare tax was not withheld? (this is not common)",
            ),
        ]
        ...
        required_fields = [
            ...
            FloatField(
                "1",
                lambda s, i, v: float(
                    sum([v[f"w-2:{n}.box_5"] for n in range(i["1040.number_w-2"])])
                ),
            ),
            FloatField(
                "2",
                lambda s, i, v: (
                    s.not_implemented() if i["other_medicare_income"] else None
                ),
            ),
            FloatField(
                "3",
            ...
            FloatField(
                "5",
                lambda s, i, v: s.form("1040").threshold(
                    "additional_medicare_tax_applies", i["1040.filing_status"]
                ),
            ),
        ...
        optional_fields = [
            ...
            FloatField(
                "8",
                lambda s, i, v: (
                    s.not_implmented() if i["1040.self_employment_income"] else None
                ),
            ),
            FloatField(
                "9",
            ...
            FloatField(
                "14",
                lambda s, i, v: (
                    s.not_implmented() if i["1040.rrta_compensation"] else None
                ),
            ),
            FloatField(
                "15",
            ...
            FloatField(
                "19",
                lambda s, i, v: float(
                    sum([v[f"w-2:{n}.box_6"] for n in range(i["1040.number_w-2"])])
                ),
            ),
