...
class FormNCD400(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            StringInput(
                "county",
                description="Enter the North Carolina county in which you resided on the last day of 2023. Your county of residence may be different than the county of your mailing address.",
            ),
            BooleanInput(
                "out_of_country",
            ...
            BooleanInput(
                "nc_residents",
                description="Were you, and your spouse if filing jointly, residents of N.C. for the entire year of 2023?",
            ),
            BooleanInput("veteran", description="Are you a veteran?"),
            BooleanInput("spouse_veteran", description="Is your spouse a veteran?"),
            BooleanInput(
                "federal_extension",
                description="Were you granted an automatic extension to file your 2023 federal income tax return, e.g., Form 1040?",
            ),
            IntegerInput(
            ...
            FloatInput(
                "estimated_tax",
                description="Enter any estimated North Carolina income tax payments for tax year 2023 (including any portion of your 2020 refund that was applied to your 2023 estimated income tax).",
            ),
            FloatInput(
                "paid_with_extension",
            ...
            FloatInput(
                "2024_estimated_income_tax",
                description="Enter the amount, if any, of your NC state refund you want applied to 2024 estimated tax",
            ),
            FloatInput(
        ...
        required_fields = [
            ...
            FloatField(
                "15", lambda s, i, v: v["14"] * 0.0475, places=0
            ),  # NC Income Tax
            FloatField(
                "16",
