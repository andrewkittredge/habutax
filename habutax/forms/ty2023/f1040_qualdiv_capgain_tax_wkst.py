...
class Form1040QualDivCapGainTaxWkst(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            BooleanInput(
                "form_2555",
                description="Do you need to fill out Form 2555 (relating to foreign earned income)?",
            ),
        ]
        ...
        optional_fields = [
            FloatField(
                "1",
                lambda s, i, v: s.not_implemented() if i["form_2555"] else v["1040.15"],
            ),
            FloatField(
                "2",
                lambda s, i, v: s.not_implemented() if i["form_2555"] else v["1040.3a"],
            ),
            FloatField(
                "3",
                lambda s, i, v: (
                    s.not_implemented()
                    if i["1040.schedule_d_required"]
                    else v["1040.7"]
                ),
            ),
            ...
            FloatField(
                "13", lambda s, i, v: s.threshold("line_13", i["1040.filing_status"])
            ),
            ...
            FloatField(
                "22", lambda s, i, v: figure_tax(v["5"], i["1040.filing_status"])
            ),
            FloatField("23", lambda s, i, v: v["18"] + v["21"] + v["22"]),
            FloatField(
                "24", lambda s, i, v: figure_tax(v["1"], i["1040.filing_status"])
            ),
