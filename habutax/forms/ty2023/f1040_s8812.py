...
class Form1040S8812(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            IntegerInput(
                "number_under_17",
                description="How many of your dependents eligible for the child tax credit with the required social security number were under age 17 with the required social security number at the end of 2023?",
            ),
            BooleanInput(
                "credit_limit_ws_b_maybe_needed",
                description="Are you using forms 5695, 8396, 8839, 8859 to report credits?",
            ),
        ]
        ...
        def line_27(self, i, v):
            ...
            return self.not_implemented(
                "Schedule 8812 has not implemented the 'Additional Child Tax Credit for All Filers'"
            )
        ...
        optional_fields = [
            ...
            FloatField(
                "9", lambda s, i, v: s.threshold("9_amount", i["1040.filing_status"])
            ),
            FloatField("10", line_10),
            FloatField("11", lambda s, i, v: v["10"] * 0.05),
            BooleanField("8_gt_11", lambda s, i, v: v["8"] > v["11"]),
            FloatField(
                "12", lambda s, i, v: v["8"] - v["11"] if v["8_gt_11"] else None
            ),
            FloatField("13", lambda s, i, v: v["clwkst_a_5"]),
            FloatField(
                "14", lambda s, i, v: min(v["12"], v["13"]) if v["8_gt_11"] else 0.0
            ),
            ...
            FloatField(
                "16b",
                lambda s, i, v: v["4"] * s.threshold("max_additional_child_tax_credit"),
            ),
        ...
        optional_fields += [
            ...
            FloatField(
                "clwkst_a_4",
                lambda s, i, v: (
                    s.not_implemented() if i["credit_limit_ws_b_maybe_needed"] else 0.0
                ),
            ),
        ...
        pdf_fields = [
            ...
            ButtonPDFField(
                "topmostSubform[0].Page1[0].c1_1[1]", "8_gt_11", "2", lambda s, v, f: v
            ),
            ...
            TextPDFField(
                "topmostSubform[0].Page2[0].f2_2[0]", "4"
            ),  # number of qualifying children for 16b
