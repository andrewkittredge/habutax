    ...
    def __init__(self, **kwargs):
        inputs = [
            EnumInput(
                ...
                description="To whom does this 1099-DIV belong?",
            ),
            StringInput("payer", description="Who paid you these dividends?"),
            StringInput(
                "recipient",
                description="To whom was this dividend paid? (you or your spouse's name)",
            ),
            ...
            EnumInput(
                "box_14_1", enum.us_states, allow_empty=True, description="State #1"
            ),
            StringInput("box_15_1", description="State #1 identification no."),
            FloatInput("box_16_1", description="State #1 tax withheld"),
            EnumInput(
                "box_14_2", enum.us_states, allow_empty=True, description="State #2"
            ),
