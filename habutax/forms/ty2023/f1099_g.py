    ...
    def __init__(self, **kwargs):
        inputs = [
            EnumInput(
                ...
                description="To whom does this 1099-G belong?",
            ),
            StringInput("payer", description="Who paid you this amount?"),
            StringInput(
                "recipient",
                description="To whom was this amount paid? (you or your spouse's name)",
            ),
            FloatInput("box_1", description="Unemployment compensation"),
            FloatInput(
                "box_2", description="State income tax refund, credit or offset"
            ),
            ...
            EnumInput(
                "box_10a_1", enum.us_states, allow_empty=True, description="State #1"
            ),
            StringInput("box_10b_1", description="State #1 identification no."),
            FloatInput("box_11_1", description="State #1 tax withheld"),
            EnumInput(
                "box_10a_2", enum.us_states, allow_empty=True, description="State #2"
            ),
