...
class Form8606(Form):
    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            BooleanInput(
                "part_1_needed",
                description=f"Do {you} need to fill out part 1 of Form 8606? This is required if one or more of the following apply: 1) {you} made nondeductible contributions to a traditional IRA for 2023, 2) {you} took distributions from a traditional, SEP, or SIMPLE IRA in 2023 and {you} made nondeductible contributions to a traditional IRA in 2023 or an earlier year, 3) {you} converted part, but not all, of {your} traditional, SEP, and SIMPLE IRAs to Roth IRAs in 2023 and {you} made nondeductible contributions to a traditional IRA in 2023 or an earlier year. See Form 8606 instructions for more information.",
            ),
            FloatInput(
                "nondeductible_contributions",
                description=f"Enter {your} nondeductible contributions to traditional IRAs for 2023, including those made for 2023 from January 1, 2024, through April 18, 2024",
            ),
            FloatInput(
                "traditional_basis",
                description=f"Enter {your} total basis in traditional IRAs. See instructions",
            ),
            BooleanInput(
                "distribution_or_roth_conversion",
                description=f"In {Form8606.tax_year}, did {you} take a distribution from traditional, SEP, or SIMPLE IRAs, or make a Roth IRA conversion?",
            ),
            FloatInput(
                "nondeductible_contributions_next_year",
                description=f"Enter {your} nondeductible contributions to traditional IRAs for 2023 made from January 1, 2024 through April 18, 2024",
            ),
            FloatInput(
                "year_end_value_non_roth",
                description=f"Enter the value of *all* {your} traditional, SEP, and SIMPLE IRAs as of December 31, 2023, plus any outstanding rollovers. Subtract any repayments of qualified disaster distributions (see 2023 Forms 8915-D and 8915-F)",
            ),
            FloatInput(
                "distributions_2023",
                description=f"Enter {your} distributions from traditional, SEP, and SIMPLE IRAs in 2023. Do *not* include rollovers (other than repayments of qualified disaster distributions (see 2023 Forms 8915-D and 8915-F)), qualified charitable distributions, a one-time distribution to fund an HSA, conversions to a Roth IRA, certain returned contributions, or recharacterizations of traditional IRA contributions (see instructions)",
            ),
            BooleanInput(
                "qualified_disaster_distributions",
                description=f"Are any of {your} distributions from traditional, SEP, and Simple IRAs in 2023 qualified disaster distributions?",
            ),
            FloatInput(
                "net_converted",
                description=f"Enter the net amount {you} converted from traditional, SEP, and SIMPLE IRAs to Roth IRAs in 2023.",
            ),
            BooleanInput(
                "part_2_needed",
                description=f"Did {you} convert part or all of {your} traditional, SEP, and SIMPLE IRAs to a Roth IRA in {Form8606.tax_year}?",
            ),
            FloatInput(
                "converted_cost_basis",
                description=f"Enter {your} cost basis for the net amount {you} converted from traditional, SEP, and SIMPLE IRAs to Roth IRAs in {Form8606.tax_year}",
            ),
            BooleanInput(
                "part_3_needed",
                description=f"Did {you} take a distribution from a Roth IRA in 2023?",
            ),
            FloatInput(
                "total_nonqualified_distributions",
                description=f"Enter {your} total nonqualified distributions from Roth IRAs in 2023, including any qualified first-time homebuyer distributions, and any qualified disaster distributions (see instructions). Also, see 2023 Forms 8915-D and 8915-F",
            ),
            FloatInput(
                "qualified_homebuyer",
                description=f"Qualified first-time homebuyer expenses (see instructions). Do not enter more than $10,000 reduced by the total of all {your} prior qualified first-time homebuyer distributions",
            ),
            FloatInput(
                "roth_ira_contributions_basis",
                description=f"Enter {your} basis in Roth IRA contributions (see instructions)",
            ),
        ]
        ...
        optional_fields = [
            ...
            FloatField(
                "10",
                lambda s, i, v: min(1.000, float(v["5"]) / float(v["9"]), 1.000),
                places=5,
            ),
            ...
            FloatField(
                "14",
                lambda s, i, v: (
                    v["3"] - v["13"] if i["distribution_or_roth_conversion"] else v["3"]
                ),
            ),
            ...
            FloatField(
                ...
                lambda s, i, v: (
                    ...
                    if i["qualified_disaster_distributions"]
                    else None
                ),
            ),
            ...
            FloatField(
                "17",
                lambda s, i, v: (
                    v["11"] if i["part_1_needed"] else i["converted_cost_basis"]
                ),
            ),
        ...
        pdf_fields = [
            ...
            TextPDFField(
                ...
                "10",
                max_length=1,
                value_fn=lambda s, v, f: f"{v:.3f}".split(".")[0],
            ),
            TextPDFField(
                "topmostSubform[0].Page1[0].f1_19[0]",
                "10",
                value_fn=lambda s, v, f: f"{v:.3f}".split(".")[1],
            ),
