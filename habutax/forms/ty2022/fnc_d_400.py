...
class FormNCD400(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            StringInput(
                "county",
                description="Enter the North Carolina county in which you resided on the last day of 2022. Your county of residence may be different than the county of your mailing address.",
            ),
            BooleanInput(
                "out_of_country",
                description="Were you or, if married filing jointly, your spouse were out of the country on the statutory due date of the return?",
            ),
            BooleanInput(
                "nc_residents",
                description="Were you, and your spouse if filing jointly, residents of N.C. for the entire year of 2022?",
            ),
            BooleanInput("veteran", description="Are you a veteran?"),
            BooleanInput("spouse_veteran", description="Is your spouse a veteran?"),
            BooleanInput(
                "federal_extension",
                description="Were you granted an automatic extension to file your 2022 federal income tax return, e.g., Form 1040?",
            ),
            IntegerInput(
                "year_spouse_died", description="Which year did your spouse die?"
            ),
            BooleanInput(
                "additions_to_agi",
                description='Do you have any additions you are required to add to your federal adjusted gross income for your North Carolina return? If unsure, answer "yes" and you will be prompted for them individually.',
            ),
            BooleanInput(
                "deductions_from_agi",
                description='Do you have any deductions you are allowed to make from your federal adjusted gross income for your North Carolina return? If unsure, answer "yes" and you will be prompted for them individually.',
            ),
            BooleanInput(
                "try_itemizing",
                description='Would you you like to see if itemizing on your NC State tax return saves you money? Even if you answer "yes" here, we will only itemize if it helps you.',
            ),
            BooleanInput(
                "partial_year_or_nonresident",
            ...
            BooleanInput(
                "nc_tax_credits",
                description="Do you want to claim any NC tax credits? These include credits for income tax paid to another state or country, rehabilitating historic structures, business incentive and energy tax credits, or credits carried over from previous years.",
            ),
            BooleanInput(
                "no_consumer_use_tax",
                description="Do you certify that no Consumer Use Tax is due to North Carolina?",
            ),
            BooleanInput(
                "amended_return",
                description="Is this an amended NC state return? (HabuTax does not support this)",
            ),
            FloatInput(
                "estimated_tax",
                description="Enter any estimated North Carolina income tax payments for tax year 2022 (including any portion of your 2020 refund that was applied to your 2022 estimated income tax).",
            ),
            FloatInput(
                "paid_with_extension",
                description="If you previously applied for a N.C. extension (Form D-410), enter the amount of North Carolina income tax paid with the extension.",
            ),
            FloatInput(
                "partnership_payments",
                description="If you are a nonresident partner in a partnership doing business in North Carolina, enter your share of the income tax paid to North Carolina by the manager of the partnership on your distributive share of the partnership income. Include with your return a copy of Form NC K-1 for Form D-403 provided by the partnership to verify the amount claimed (you must do this outside of HabuTax)",
            ),
            FloatInput(
                "s_corp_payments",
            ...
            BooleanInput(
                "late",
                description="Are you filing this return after the original due date?",
            ),
            FloatInput(
                "interest_on_underpayment",
                description="It is possible you owe interest because you have underpaid your NC income tax. Please complete NC Form D-422 to determine the amount, if any, of interest you owe and enter that amount here.",
            ),
            FloatInput(
                "2022_estimated_income_tax",
                description="Enter the amount, if any, of your NC state refund you want applied to 2022 estimated tax",
            ),
            FloatInput(
                "nc_nongame_endangered_wildlife",
                description="Enter the amount, if any, of your NC state refund you want to contribute to the NC Nongame and Endangered Wildlife Fund",
            ),
            FloatInput(
                "nc_education_endowment",
                description="Enter the amount, if any, of your NC state refund you want to contribute to the N.C Education Endowment Fund",
            ),
            FloatInput(
                "nc_breast_cervical_cancer",
                description="Enter the amount, if any, of your NC state refund you want to contribute to the N.C Breast and Cervical Cander Control Program",
            ),
        ]
        ...
        def your_tax_withheld(self, i, v):
            return tax_withheld(
                ...
                [
                    ...
                    enum.taxpayer_spouse_or_both.taxpayer,
                    enum.taxpayer_spouse_or_both.both,
                ],
            )
        ...
        def spouses_tax_withheld(self, i, v):
            return tax_withheld(
                ...
                i,
                v,
                [enum.taxpayer_or_spouse.spouse, enum.taxpayer_spouse_or_both.spouse],
            )
        ...
        required_fields = [
            ...
            StringField(
                ...
                lambda s, i, v: (
                    i["1040.spouse_ssn"][:3]
                    + "-"
                    + i["1040.spouse_ssn"][3:5]
                    + "-"
                    + i["1040.spouse_ssn"][5:]
                    if i["1040.filing_status"]
                    == enum.filing_status.MarriedFilingJointly
                    else None
                ),
            ),
            StringField(
                "your_first_name", lambda s, i, v: i["1040.first_name"].upper()
            ),
            StringField(
                "your_middle_initial", lambda s, i, v: i["1040.middle_initial"].upper()
            ),
            StringField("your_last_name", lambda s, i, v: i["1040.last_name"].upper()),
            StringField(
                "spouse_first_name",
                lambda s, i, v: (
                    i["1040.spouse_first_name"].upper()
                    if i["1040.filing_status"]
                    == enum.filing_status.MarriedFilingJointly
                    else None
                ),
            ...
            StringField(
                ...
                lambda s, i, v: (
                    i["1040.spouse_middle_initial"].upper()
                    if i["1040.filing_status"]
                    == enum.filing_status.MarriedFilingJointly
                    else None
                ),
            ...
            StringField(
                "mailing_address", lambda s, i, v: i["1040.home_address"].upper()
            ),
            ...
            BooleanField(
                "1",
                lambda s, i, v: i["1040.filing_status"] == enum.filing_status.Single,
            ),
            BooleanField(
                "2",
                lambda s, i, v: i["1040.filing_status"]
                == enum.filing_status.MarriedFilingJointly,
            ),
            BooleanField(
                "3",
                lambda s, i, v: i["1040.filing_status"]
                == enum.filing_status.MarriedFilingSeparately,
            ),
            BooleanField(
                "4",
                lambda s, i, v: i["1040.filing_status"]
                == enum.filing_status.HeadOfHousehold,
            ),
            BooleanField(
                "5",
                lambda s, i, v: i["1040.filing_status"]
                == enum.filing_status.QualifyingSurvivingSpouse,
            ),
            StringField(
                "separate_spouse_name",
                lambda s, i, v: (
                    f'i["1040.first_name"] i["1040.middle_initial"] i["1040.last_name"]'.upper()
                    if v["3"]
                    else None
                ),
            ),
            ...
            StringField(
                "year_spouse_died",
                lambda s, i, v: i["year_spouse_died"] if v["5"] else None,
            ),
            FloatField("6", lambda s, i, v: v["1040.11"], places=0),
            FloatField(
                "7",
                lambda s, i, v: v["nc_d-400_ss.15"] if i["additions_to_agi"] else None,
                places=0,
            ),
            ...
            FloatField(
                "9",
                lambda s, i, v: (
                    v["nc_d-400_ss.41"] if i["deductions_from_agi"] else None
                ),
                places=0,
            ),
            ...
            FloatField(
                "10b",
                lambda s, i, v: (
                    v["nc_d-400_child_deduction_wkst.5"] if v["10a"] > 0 else None
                ),
                places=0,
            ),
            BooleanField(
                "11_itemizing",
                lambda s, i, v: i["try_itemizing"]
                and v["nc_d-400_sa.deduction"] > v["nc_d-400_sa.nc_standard_deduction"],
            ),
            FloatField(
                "11",
                lambda s, i, v: (
                    v["nc_d-400_sa.deduction"]
                    if v["11_itemizing"]
                    else v["nc_d-400_sa.nc_standard_deduction"]
                ),
                places=0,
            ),
            ...
            FloatField(
                "13",
                lambda s, i, v: (
                    s.not_implemented() if i["partial_year_or_nonresident"] else None
                ),
                places=0,
            ),
            FloatField(
                ...
                lambda s, i, v: (
                    s.not_implemented()
                    if i["partial_year_or_nonresident"]
                    else v["12b"]
                ),
                places=0,
            ),
            FloatField(
                "15", lambda s, i, v: v["14"] * 0.0499, places=0
            ),  # NC Income Tax
            FloatField(
                "16",
                lambda s, i, v: s.not_implemented() if i["nc_tax_credits"] else None,
                places=0,
            ),
            FloatField("17", lambda s, i, v: v["15"] - v["16"], places=0),
            BooleanField(
                "no_consumer_use_tax", lambda s, i, v: i["no_consumer_use_tax"]
            ),
            FloatField(
                "18",
                lambda s, i, v: (
                    None
                    if v["no_consumer_use_tax"]
                    else v["nc_d-400_consumer_use_tax_wkst.consumer_use_tax"]
                ),
                places=0,
            ),
            ...
            FloatField(
                "22",
                lambda s, i, v: s.not_implemented() if i["amended_return"] else None,
                places=0,
            ),
            FloatField(
                "23",
            ...
            FloatField(
                "refund",
                lambda s, i, v: v["34"] if v["19"] <= v["25"] else -v["27"],
                places=0,
            ),  # Fake "field" to ensure only correct portion is filled
        ]
        ...
        optional_fields = [
            ...
            FloatField(
                "26a",
                lambda s, i, v: (
                    v["19"] - v["25"] if v["25"] < v["19"] else s.not_implemented()
                ),
                places=0,
            ),
            FloatField(
                "26b",
                lambda s, i, v: s.not_implemented() if i["late"] else None,
                places=0,
            ),
            FloatField(
                "26c",
            ...
            FloatField(
                "26e",
                lambda s, i, v: (
                    i["interest_on_underpayment"]
                    if (v["17"] - (v["20a"] + v["20b"]) >= 1000)
                    else None
                ),
                places=0,
            ),
            ...
            FloatField(
                "28",
                lambda s, i, v: (
                    v["25"] - v["19"] if v["25"] >= v["19"] else s.not_implemented()
                ),
                places=0,
            ),
            FloatField("29", lambda s, i, v: i["2022_estimated_income_tax"], places=0),
            FloatField(
                "30", lambda s, i, v: i["nc_nongame_endangered_wildlife"], places=0
            ),
            ...
            FloatField(
                "33", lambda s, i, v: v["29"] + v["30"] + v["31"] + v["32"], places=0
            ),
            FloatField(
                "34",
                lambda s, i, v: (
                    v["28"] - v["33"] if v["28"] >= v["33"] else s.not_implemented()
                ),
                places=0,
            ),
        ]
        ...
        pdf_fields = [
            ...
            ButtonPDFField(
                "y_d400wf_rs1no", "nc_residents", "Yes", lambda s, v, f: not v
            ),
            ButtonPDFField("y_d400wf_rs2yes", "nc_residents", "Yes"),
            ButtonPDFField(
                "y_d400wf_rs2no", "nc_residents", "Yes", lambda s, v, f: not v
            ),
            ...
            ButtonPDFField(
                "y_d400wf_sv1no", "spouse_veteran", "Yes", lambda s, v, f: not v
            ),
            ButtonPDFField("y_d400wf_fedex1yes", "federal_extension", "Yes"),
            ButtonPDFField(
                "y_d400wf_fedex1no", "federal_extension", "Yes", lambda s, v, f: not v
            ),
