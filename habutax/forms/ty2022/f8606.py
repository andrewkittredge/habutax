    ...
    def __init__(self, **kwargs):
        ...
        inputs = [
            ...
            FloatInput(
                ...
                description=f"Enter {your} nondeductible contributions to traditional IRAs for 2022, including those made for 2022 from January 1, 2023, through April 15, 2023",
            ),
            FloatInput(
                "traditional_basis",
            ...
            FloatInput(
                ...
                description=f"Enter {your} nondeductible contributions to traditional IRAs for 2022 made from January 1, 2023 through April 15, 2023",
            ),
            FloatInput(
                "year_end_value_non_roth",
                description=f"Enter the value of *all* {your} traditional, SEP, and SIMPLE IRAs as of December 31, 2022, plus any outstanding rollovers. Subtract any repayments of qualified disaster distributions (see 2022 Forms 8915-D and 8915-F)",
            ),
            FloatInput(
                "distributions_2022",
                description=f"Enter {your} distributions from traditional, SEP, and SIMPLE IRAs in 2022. Do *not* include rollovers (other than repayments of qualified disaster distributions (see 2022 Forms 8915-D and 8915-F)), qualified charitable distributions, a one-time distribution to fund an HSA, conversions to a Roth IRA, certain returned contributions, or recharacterizations of traditional IRA contributions (see instructions)",
            ),
            BooleanInput(
                "qualified_disaster_distributions",
                description=f"Are any of {your} distributions from traditional, SEP, and Simple IRAs in 2022 qualified disaster distributions?",
            ),
            FloatInput(
                "net_converted",
                description=f"Enter the net amount {you} converted from traditional, SEP, and SIMPLE IRAs to Roth IRAs in 2022.",
            ),
            BooleanInput(
                "part_2_needed",
            ...
            BooleanInput(
                "part_3_needed",
                description=f"Did {you} take a distribution from a Roth IRA in 2022?",
            ),
            FloatInput(
                "total_nonqualified_distributions",
                description=f"Enter {your} total nonqualified distributions from Roth IRAs in 2022, including any qualified first-time homebuyer distributions, and any qualified disaster distributions (see instructions). Also, see 2022 Forms 8915-D and 8915-F",
            ),
            FloatInput(
                "qualified_homebuyer",
