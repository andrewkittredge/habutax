    ...
    def __init__(self, **kwargs):
        inputs = [
            EnumInput(
                ...
                description="To whom does this 1099-INT belong?",
            ),
            StringInput("payer", description="Who paid you this interest?"),
            StringInput(
                "recipient",
                description="To whom was this interest paid? (you or your spouse's name)",
            ),
            ...
            EnumInput(
                ...
                enum.us_states,
                allow_empty=True,
                description="State #1 for which tax was withheld",
            ),
            ...
            EnumInput(
                ...
                enum.us_states,
                allow_empty=True,
                description="State #2 for which tax was withheld",
            ),
