...
class FormNCD400SA(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            FloatInput(
                "claim_of_right_income",
                description="Enter any 'Repayment of Claim of Right Income' which you can claim a NC deduction for (this is not common). See the instructions for NC D-400 Schedule A, line 8 for more information",
            ),
        ]
        ...
        def nc_standard_deduction(self, i, v):
            if i["1040.filing_status"] in [
                ...
                i["1040.filing_status"] == filing_status.MarriedFilingSeparately
                and not i["1040.standard_deduction_exceptions"]
            ):
                return 12750.0
        ...
        optional_fields = [
            ...
            FloatField(
                "2",
                lambda s, i, v: min(
                    i["1040_sa.state_local_real_estate_taxes"],
                    real_estate_tax_limit(s, i, v),
                ),
                places=0,
            ),
            ...
            FloatField(
                "6",
                lambda s, i, v: min(
                    i["1040_sa.charitable_cash_check"]
                    + i["1040_sa.charitable_other_than_cash_check"],
                    v["1040.11"] * 0.6,
                ),
                places=0,
            ),
            FloatField(
                "7a", lambda s, i, v: i["1040_sa.medical_dental_expenses"], places=0
            ),
            FloatField("7b", lambda s, i, v: v["nc_d-400.6"], places=0),
            FloatField("7c", lambda s, i, v: max(0.0, v["7b"] * 0.075), places=0),
            FloatField(
                "7d",
                lambda s, i, v: 0.0 if v["7c"] > v["7a"] else v["7a"] - v["7c"],
                places=0,
            ),
            ...
            FloatField(
                "10",
                lambda s, i, v: v["5"] + v["6"] + v["7d"] + v["8"] + v["9"],
                places=0,
            ),
        ]
        ...
        required_fields = [
            ...
            FloatField(
                "deduction",
                lambda s, i, v: max(v["nc_standard_deduction"], v["10"]),
                places=0,
            ),
        ]
