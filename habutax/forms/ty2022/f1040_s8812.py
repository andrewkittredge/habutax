...
class Form1040S8812(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            ...
            IntegerInput(
                "number_under_17",
                description="How many of your dependents eligible for the child tax credit with the required social security number were under age 17 with the required social security number at the end of 2022?",
            ),
            BooleanInput(
