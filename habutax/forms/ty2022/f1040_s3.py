...
class Form1040S3(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            ...
            BooleanInput(
                "education_credit",
                description="Did you (or your dependent) pay qualified expenses in 2022 for yourself, your spouse, or your dependent to enroll in or attend an eligible educational institution? If so, do you need to claim an education credit on Form 8863?",
            ),
            BooleanInput(
            ...
            BooleanInput(
                ...
                description="Did you pay for any energy-efficient upgrades to your home in 2022? This might be things like installing solar panels, wind energy installations, adding insulation or high-efficiency HVAC units.",
            ),
            BooleanInput(
        ...
        optional_fields = [
            ...
            FloatField(
                ...
                lambda s, i, v: (
                    s.not_implemented()
                    if v["1040.11"] <= retirement_savings_limit(s, i, v)
            ...
            FloatField(
                "8", lambda s, i, v: sum([v[f"{n}"] for n in range(1, 5 + 1)]) + v["7"]
            ),
        ]
        required_fields = [
            StringField(
        ...
        pdf_fields = [
            ...
            TextPDFField(
                "topmostSubform[0].Page1[0].Line6z_ReadOrder[0].f1_20[0]", "6z_type"
            ),
            TextPDFField(
                "topmostSubform[0].Page1[0].Line6z_ReadOrder[0].f1_21[0]", "6z_type"
            ),
