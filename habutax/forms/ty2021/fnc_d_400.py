...
class FormNCD400(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            StringInput(
                "county",
                description="Enter the North Carolina county in which you resided on the last day of 2021. Your county of residence may be different than the county of your mailing address.",
            ),
            BooleanInput(
                "out_of_country",
            ...
            BooleanInput(
                "nc_residents",
                description="Were you, and your spouse if filing jointly, residents of N.C. for the entire year of 2021?",
            ),
            BooleanInput("veteran", description="Are you a veteran?"),
            BooleanInput("spouse_veteran", description="Is your spouse a veteran?"),
            BooleanInput(
                "federal_extension",
                description="Were you granted an automatic extension to file your 2021 federal income tax return, e.g., Form 1040?",
            ),
            IntegerInput(
            ...
            FloatInput(
                "estimated_tax",
                description="Enter any estimated North Carolina income tax payments for tax year 2021 (including any portion of your 2020 refund that was applied to your 2021 estimated income tax).",
            ),
            FloatInput(
                "paid_with_extension",
        ...
        required_fields = [
            ...
            BooleanField(
                ...
                == enum.filing_status_2021.Single,
            ),
            BooleanField(
                "2",
                lambda s, i, v: i["1040.filing_status"]
            ...
            BooleanField(
                "3",
                lambda s, i, v: i["1040.filing_status"]
                == enum.filing_status_2021.MarriedFilingSeparately,
            ),
            BooleanField(
                "4",
                lambda s, i, v: i["1040.filing_status"]
                == enum.filing_status_2021.HeadOfHousehold,
            ),
            BooleanField(
                "5",
                lambda s, i, v: i["1040.filing_status"]
                == enum.filing_status_2021.QualifyingWidowWidower,
            ),
            StringField(
            ...
            FloatField(
                "9",
                lambda s, i, v: (
                    v["nc_d-400_ss.38"] if i["deductions_from_agi"] else None
                ),
                places=0,
            ),
            ...
            FloatField(
                "15", lambda s, i, v: v["14"] * 0.0525, places=0
            ),  # NC Income Tax
            FloatField(
                "16",
        ...
        optional_fields = [
            ...
            FloatField(
                "26a",
                lambda s, i, v: (
                    v["19"] - v["25"] if v["19"] > v["25"] else s.not_implemented()
                ),
                places=0,
            ),
            FloatField(
            ...
            FloatField(
                "28",
                lambda s, i, v: (
                    v["25"] - v["19"] if v["19"] <= v["25"] else s.not_implemented()
                ),
                places=0,
            ),
