...
class Form1099R(InputForm):
    ...
    def __init__(self, **kwargs):
        inputs = [
            ...
            StringInput(
                "recipient",
                description="To whom was this distribution paid? (you or your spouse's name)",
            ),
            EnumInput(
                "belongs_to",
                enum.taxpayer_or_spouse,
                description="To whom was this distribution paid?",
            ),
            FloatInput("box_1", description="Gross distribution"),
            FloatInput("box_2a", description="Taxable amount"),
            BooleanInput(
                "box_2b_taxable_not_determined",
                description="'Taxable amount not determined' checked",
            ),
            BooleanInput(
                "box_2b_total_distribution", description="'Total distribution' checked"
            ),
            FloatInput("box_3", description="Capital gain (included in box 2a)"),
            FloatInput("box_4", description="Federal income tax withheld"),
            FloatInput(
                "box_5",
                description="Employee contributions/Designated Roth contributions or insurance premiums",
            ),
            FloatInput(
                "box_6",
            ...
            BooleanInput(
                "box_7_ira_sep_simple", description="'IRA/SEP/SIMPLE' checked"
            ),
            ...
            StringInput(
                "box_14", description="Tax-exempt and tax credit bond CUSIP no."
            ),
            ...
            EnumInput(
                ...
                enum.us_states,
                allow_empty=True,
                description="State for which tax was withheld",
            ),
