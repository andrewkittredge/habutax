...
class Form1040S3(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            ...
            BooleanInput(
                "education_credit",
                description="Did you (or your dependent) pay qualified expenses in 2021 for yourself, your spouse, or your dependent to enroll in or attend an eligible educational institution? If so, do you need to claim an education credit on Form 8863?",
            ),
            BooleanInput(
            ...
            BooleanInput(
                ...
                description="Did you pay for any energy-efficient upgrades to your home in 2021? This might be things like installing solar panels, wind energy installations, adding insulation or high-efficiency HVAC units.",
            ),
            BooleanInput(
