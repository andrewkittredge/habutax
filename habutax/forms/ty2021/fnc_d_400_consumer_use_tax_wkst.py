...
class FormNCD400ConsumerUseTaxWkst(Form):
    ...
    def __init__(self, **kwargs):
        inputs = [
            BooleanInput(
                "full_records",
                description="Do you have records of out-of-state (NC) purchases your or your spouse made for tax year 2021?",
            ),
            FloatInput(
                "out_of_state_purchases",
                description="Enter the total amount of out-of-state purchases, including delivery charges, for 1/1/21 through 12/31/21",
            ),
            FloatInput(
                "county_tax_pct",
        ...
        optional_fields = [
            ...
            FloatField(
                "3", lambda s, i, v: min(i["other_state_sales_tax"], v["1"]), places=0
            ),
